...
dir.create('res')
write_excel_csv2(comparableLoinc, file="res/comparableLoincTerms.csv")
write_excel_csv2(comparableLoinc %>% filter(LOINC_NUM %in% loinc_de$LOINC_NUM),
                 file="res/comparableLoincTermsDE.csv")
